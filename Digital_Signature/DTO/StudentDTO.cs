...
namespace Digital_Signature.DTO
{
    internal class StudentDTO
    {
        ...
        public StudentDTO(int stu_id_, string name_, string sex_, DateTime birthday_, string graduation_year_, string email_, string place_of_birth_, string phone_, string religion_, int user_id_)
        {
            this.stu_id = stu_id_;
            this.name = name_;
            this.sex = sex_;
